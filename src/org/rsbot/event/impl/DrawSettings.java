...
public class DrawSettings implements PaintListener {
	public final static DrawSettings inst = new DrawSettings();
	...
	public void onRepaint(final Graphics render) {
		final int[] settings = Bot.getClient().getSettingArray() != null ? Bot.getClient().getSettingArray().getData() : null;
		if (settings != null) {
